...
import { Stack, Typography, Container, Paper, CircularProgress, Box, Grid } from "@mui/material";
        ...
        <Container maxWidth="xl" sx={{ py: 4 }}>
            <Paper elevation={0} sx={{ px: 5.5, py: 4, borderRadius: 5 }}>
                ...
                <Typography sx={{ mb: 4, color: "text.secondary" }}>
                    Track delivery spaces where PM owns timelines, breaks work
                    into tasks, and prepares updates for the Secretary agent to
                    summarize.
                </Typography>
