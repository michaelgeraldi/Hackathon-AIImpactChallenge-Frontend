        ...
        <Container maxWidth="xl" sx={{ py: 4 }}>
            <Paper elevation={0} sx={{ px: 5.5, py: 4, borderRadius: 5 }}>
                ...
                <Typography sx={{ mb: 4, color: "text.secondary" }}>
                    ...
                    breakdowns, work checks, and report-ready updates.
                    Secretary keeps every conversation summarized around the
                    same project.
                </Typography>
                <Typography sx={{ mb: 4, fontSize: 13, color: "text.secondary" }}>
                    Backend status: {backendHealth?.status || "checking PM service..."}
                </Typography>
